...
const values = [
  ...
  { icon: Compass, title: "Yours, forever",  desc: "Export anytime. Your archive should outlive any single app." },
  { icon: Sprout,  title: "Quietly powerful",desc: "We hide complexity until you need it — then it's right there." },
];
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="border-t border-border bg-card/40">
        <div className="mx-auto max-w-6xl px-6 py-20">
          <div className="text-xs font-semibold uppercase tracking-wider text-primary">What we value</div>
          <h2 className="mt-2 text-3xl font-semibold tracking-tight text-foreground">A few quiet principles.</h2>
        ...
        <div className="mx-auto max-w-6xl px-6 py-20">
          <div className="grid gap-6 sm:grid-cols-3">
            {[
              ...
              <div key={s.k} className="rounded-2xl border border-border bg-card p-8 text-center">
      ...
      <section className="border-t border-border bg-card/40">
        <div className="mx-auto max-w-3xl px-6 py-20 text-center">
          <h2 className="text-3xl font-semibold tracking-tight text-foreground">Come build your own.</h2>
