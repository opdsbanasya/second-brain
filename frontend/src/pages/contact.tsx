  ...
  const onSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    setTimeout(() => {
      ...
      toast.success("Message sent!", {
        description: "We'll get back to you within a day or two.",
      });
        ...
        <div className="grid gap-12 lg:grid-cols-2">
          <div>
            ...
            <p className="mt-4 text-base leading-relaxed text-muted-foreground">
              Bug report, feature wish, or just want to chat about second
              brains? Pick whichever feels right.
            </p>
            ...
            <div className="mt-10 space-y-5">
              {[
                { icon: Mail, title: "Email", value: "hello@secondbrain.app" },
                {
                  icon: MessageSquare,
                  title: "Support",
                  value: "support@secondbrain.app",
                },
                {
                  icon: MapPin,
                  title: "Office",
                  value: "Remote-first · headquartered nowhere",
                },
          ...
          >
            ...
            <Field label="Subject" id="subject" className="mt-4">
              <Input
                ...
                name="subject"
                required
                placeholder="A bug, an idea, a 'hello'..."
              />
            </Field>
