...
export default function RegisterPage() {
  ...
  return (
    <div className="flex min-h-screen w-full bg-white text-neutral-900 font-sans selection:bg-[#4F46E5]/10 selection:text-[#4F46E5]">
      ...
      {/* RIGHT SIDE: Signup Form (Linear / Stripe Vibe) */}
        ...
        <div className="my-auto w-full max-w-sm mx-auto space-y-6">
          ...
          <div className="space-y-1.5">
            ...
            <p className="text-xs sm:text-sm text-neutral-500 font-medium">
              Start saving notes, links and ideas in less than a minute.
            </p>
          </div>

          {/* Benefits Checklist */}
          <div className="grid grid-cols-2 gap-2 text-xs font-medium text-neutral-600 bg-neutral-50 border border-neutral-100 p-3.5 rounded-2xl">
            <div className="flex items-center gap-1.5">
          ...
          <form className="space-y-3.5" onSubmit={handleSubmit(onSubmit)}>
            ...
            <Button
              ...
              disabled={loading}
            >
              {loading ? "Creating Account..." : "Start Building My Second Brain"}
            </Button>
          </form>
